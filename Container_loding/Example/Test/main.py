...
class Item:
    ...
    def get_data(self):
        ...
        return "{} {} {} {} {} {}".format(int(dim[0]),int(dim[1]),int(dim[2]),int(self.position[0]),int(self.position[1]),int(self.position[2]))
...
class Bin:
    ...
    def put_item(self, item, pivot):
        ...
        for i in range(0, len(RotationType.ALL)):
            ...
            # Loop ตรวจดูว่าถ้าใส่เข้าไปใน container แล้วจะมีส่วนที่กล่อง intersect กันหรือไม่
            # self.items คือกล่องทั้งหมดที่ใส่ใน container ไปแล้ว
