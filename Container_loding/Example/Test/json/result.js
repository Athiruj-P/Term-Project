  ...
  total_result = {
    ...
    "result_2": [
      ...
      {
        "x": [0, 0, 4, 4, 0, 0, 4, 4],
        "y": [30, 32, 30, 32, 30, 32, 30, 32],
        "z": [5, 5, 5, 5, 13, 13, 13, 13]
      },
    ...
    "result_3": [
      ...
      {
        "x": [25, 25, 27, 27, 25, 25, 27, 27],
        "y": [8, 10, 8, 10, 8, 10, 8, 10],
        "z": [13, 13, 13, 13, 14, 14, 14, 14]
      },
    ...
    "result_4": [
      {
        "x": [25, 25, 30, 30, 25, 25, 30, 30],
        "y": [10, 20, 10, 20, 10, 20, 10, 20],
        "z": [0, 0, 0, 0, 13, 13, 13, 13]
      },

      {
        "x": [25, 25, 30, 30, 25, 25, 30, 30],
        "y": [10, 18, 10, 18, 10, 18, 10, 18],
        "z": [13, 13, 13, 13, 20, 20, 20, 20]
      },

      {
        "x": [25, 25, 27, 27, 25, 25, 27, 27],
        "y": [18, 20, 18, 20, 18, 20, 18, 20],
        "z": [13, 13, 13, 13, 14, 14, 14, 14]
      },
    ...
    "result_6": [
      {
        "x": [10, 10, 25, 25, 10, 10, 25, 25],
        "y": [25, 31, 25, 31, 25, 31, 25, 31],
        "z": [0, 0, 0, 0, 5, 5, 5, 5]
      },
...

      {
        "x": [10, 10, 25, 25, 10, 10, 25, 25],
        "y": [25, 31, 25, 31, 25, 31, 25, 31],
        "z": [10, 10, 10, 10, 15, 15, 15, 15]
      }
    ],
    "result_7": [
      {
        "x": [20, 20, 27, 27, 20, 20, 27, 27],
        "y": [20, 25, 20, 25, 20, 25, 20, 25],
        "z": [0, 0, 0, 0, 8, 8, 8, 8]
      },

      {
        "x": [20, 20, 27, 27, 20, 20, 27, 27],
        "y": [20, 25, 20, 25, 20, 25, 20, 25],
        "z": [8, 8, 8, 8, 16, 16, 16, 16]
      }
    ],
    "result_8": [
      {
        "x": [0, 0, 7, 7, 0, 0, 7, 7],
        "y": [33, 38, 33, 38, 33, 38, 33, 38],
        "z": [0, 0, 0, 0, 8, 8, 8, 8]
      },
